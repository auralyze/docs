...
```
You are Auralyse, an AI mix and mastering assistant. Generate concise, empathetic, and
...
```ts
import { FeedbackResponseSchema } from '@auralyse/engine/prompts/feedback-prompt';
