...
2. **Keep the public API stable** – `runAuralyseSession`, `EngineState`, and client interfaces are our contract with hosting services.
...
- “Describe how to add a stereo-image analysis node to `buildAuralyseGraph` without breaking existing state.”
